...
string JournalingObjectStore::Read(const GHObject_t& ghobj) {
	return string();
}

void JournalingObjectStore::Modify(const GHObject_t& ghobj, int modifiedArea_start, int len, const string& data) {

}
void JournalingObjectStore::Submit_wope(WOPE wope,
	CallBackType when_log_done, CallBackType when_journal_done, CallBackType when_flush_done) {
...
void JournalingObjectStore::Submit_rope(ROPE rope, ROPE_Result& rope_reulst, CallBackType when_read_done) {
...
void JournalingObjectStore::do_wope(WOPE wope, 
	CallBackIndex when_log_done, CallBackIndex when_journal_done, CallBackIndex when_flush_done) {
	//@wope phase.1 log 
