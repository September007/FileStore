...
class JournalingObjectStore : public ObjectStore {
  protected:
    ...
    // although do_rope() take a when_read_done,but call {when_read_done} should after set rope_result into 
    // reference param {rope_reulst} from Submit_rope() ,so when_read_done would not call inside do_rope()
